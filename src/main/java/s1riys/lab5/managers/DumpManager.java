...
import s1riys.lab5.exceptions.InvalidCSVContentException;
...
public class DumpManager {
    ...
    /**
     * Constructs a DumpManager object with the specified file name and console.
     *
     * @param fileName The name of the file to read from or write to.
     * @param console  The console object used for printing messages.
     */
    public DumpManager(String fileName, IConsole console) {
